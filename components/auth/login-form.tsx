  ...
  return (
    <div className="w-full max-w-md space-y-8 p-8 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
      <div className="text-center">
        <h2 className="text-3xl font-bold text-[#1E1E2C] dark:text-white">Welcome Back</h2>
        <p className="mt-2 text-gray-600 dark:text-gray-400">
          Sign in to access your code and posts
        </p>
      </div>
      ...
      <div className="space-y-3">
        <Button
          type="button"
          variant="outline"
          className="w-full h-12 border-2 border-gray-300 dark:border-gray-600 hover:border-[#F29F67] hover:bg-[#F29F67]/10 transition-all"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link 
              ...
              className="text-xs text-[#F29F67] hover:text-[#E08D55] font-medium"
            >
              Forgot password?
            </Link>
          </div>
        ...
        <Button 
          type="submit" 
          className="w-full bg-[#F29F67] hover:bg-[#E08D55] text-[#1E1E2C]" 
      ...
      <div className="text-center text-sm">
        ...
        <Link href="/auth/signup" className="text-[#F29F67] hover:text-[#E08D55] font-semibold">
          Create Account
        </Link>
      </div>
    </div>
